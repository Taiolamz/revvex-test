...
import "../../styles/landing-page/terms.scss";
...
const Terms = () => {
  return (
    <div>
      ...
      <Row className="mt-5 terms-service">
        <Col className="mt-5">
          <h4 className="mt-3 p-5 text-center">Terms of Service</h4>
        </Col>
      </Row>
      <Container className="terms">
        <Row className="mt-5">
          <Col className="mt-5">
            ...
            <ol className="mt-3 ">
              <li className="mt-3">Agreement of terms</li>
              <li className="mt-3">Intellectual Property Rights</li>
              <li className="mt-3">User Representation</li>
              <li className="mt-3">User Registration</li>
              <li className="mt-3">Prohibited Activities</li>
              <li className="mt-3">User Generated Contributions</li>
              <li className="mt-3">Contribution License</li>
              <li className="mt-3">Mobile Application License</li>
              <li className="mt-3">Submissions</li>
              <li className="mt-3">Site Management</li>
              <li className="mt-3">Terms and Termination</li>
              <li className="mt-3">Modification and Interruptions</li>
              <li className="mt-3">Governing Law</li>
              <li className="mt-3">Dispute Resolution</li>
              <li className="mt-3">Corrections</li>
              <li className="mt-3">Disclaimer</li>
              <li className="mt-3">Limitations of Liability</li>
              <li className="mt-3">Indemnification</li>
              <li className="mt-3">User Data</li>
              <li className="mt-3">
                Electronic Communications,
                <br /> Transactions, and Signatures
              </li>
              <li className="mt-3">Miscellaneous</li>
          ...
          <Col className="mt-5 col-9">
            <ol>
              <li className="lists mx-5">Agreement of Terms</li>
              <p className="mt-4">
                These Terms of Use constitute a legally binding agreement made
                between you, whether personally or on behalf of an entity and
                Zoja Technologies, concerning your access to and use of the
                https://revvex.io website as well as any other media form, media
                channel, mobile website or mobile application related, linked,
                or otherwise connected thereto. We are registered in Nigeria and
                have our registered office at 9B, Akin Ogunmade Davies ​​Street,
                Gbagada, Nigeria. You agree that by accessing the Site, you have
                read, understood, and agreed to be bound by all these Terms of
              ...
              <li className="lists mx-5 mt-4">Intellectual Property Rights</li>
              <p className="mt-4">
                ...
                property rights and unfair competition laws of Nigeria,
              ...
              <li className="mt-4 mx-5 lists">User Representation</li>
              ...
              <p className="mt-4">
                ...
                have received parental permission to use the Site (5) you will
              ...
              <li className="mt-4 mx-5 lists">User Registration</li>
              <p className="mt-4">
              ...
              <li className="mt-4 lists mx-5">Prohibited Activites</li>
              <p className="mt-4">
              ...
              <li className="mt-4 mx-5 lists">User Generated Contributinons</li>
              <br />
              <p className="mt-4">
              ...
              <ul className="mx-5">
                ...
                <li className="mt-4">
                  ...
                  each identifiable individual person in your Contributions to
              ...
              <br />
              <li className="mt-4 mx-5 lists">Contributions License</li>
              <br />
              <p className="mt-4">
              ...
              <br />
              <li className="mt-4 mx-5 lists">Mobile Application License</li>
              <p className="mt-4 lists mx-5">Use License</p>
              <p className="mt-4">
              ...
              <br />
              <p className="mt-4 lists">Apple and Android Devices</p>
              <p className="mt-4">
              ...
              <br />
              <li className="mt-4 mx-5 lists">Submissions</li>
              <br />
              <p className="mt-4">
              ...
              <br />
              <li className="mt-4 mx-5 lists">Site Management</li>
              <br />
              <p className="mt-4">
              ...
              <br />
              <li className="mt-4 mx-5 lists">Terms and Termination</li>
              <br />
              <p className="mt-4">
              ...
              <br />
              <li className="mt-4 mx-5 lists">Governing Laws</li>
              <br />
              <p className="mt-4">
                These Terms shall be governed by and defined following the laws
                of Nigeria. Zoja Technologies and yourself irrevocably consent
              ...
              <br />
              <li className="mt-4 mx-4 lists">Dispute Resolution</li>
              <br />
              <p className="informal mt-4 lists">Informal Negotiation</p>
              <br />
              <p>
              ...
              <br />
              <p className="lists mt-4">Binding Arbitration</p>
              <br />
              <p>
                Any dispute arising out of or in connection with this contract,
                including any question regarding its existence, validity, or
                termination, shall be referred to and finally resolved by the
                Nigerian court The governing law of the contract shall be the
                substantive law of Nigeria.
              </p>
              <br />
              <p className="lists">Restrictions</p>
              <br />
              <p>
                ...
                capacity on behalf of the public or any other persons.
              </p>
              <br />
              <p className="lists">
              ...
              <br />
              <li className="mt-4 mx-5 lists">Corrections</li>
              <br />
              <p className="mt-4">
              ...
              <li className="mt-4 mx-5 lists">Disclaimer</li>
              ...
              <li className="mt-4 mx-5 lists">Limitations of Liability</li>
              <br />
              ...
              <p>
                ...
                OF THE AMOUNT PAID, IF ANY, BY YOU TO US
              </p>
              <br />
              <li className="lists mx-5 mt-4">Indemnification</li>
              <br />
              <p className="mt-4">
              ...
              <li className="mt-4 mx-5 lists">User Data</li>
              ...
              <br />
              <li className="mt-4 mx-5 lists">Miscellaneous</li>
              <br />
              <p className="mt-4">
                ...
                Terms of Use fully operate permissible by law. We may assign any
                or all our rights and obligations to others at any time. We
                ...
                between you and us because of these Terms of Use or use of the
              ...
              <br />
              <li className="mt-4 mx-5 lists">Contact Us</li>
              <br />
              <p className="mt-4">
              ...
              <br />
              <p className="mt-4">Zoja Technologies</p>
              <br />
              <p>
                Address:{" "}
                <a href="https://www.zojatech.com">https://www.zojatech.com</a>
              </p>
            </ol>
          </Col>
        </Row>
